...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const syncQuoteBtn = document.getElementById("syncQuotes");
        ...
        if (displayedQuote && displayedQuote.editable === true) {
            ...
            deleteBtn.addEventListener("click", async () => {
                try {
                    ...
                    localStorage.setItem("savedQuotes", JSON.stringify(categoryFiler));

                    /**
                     * Reshuffle the quotes to be displayed
                     */
                    shuffled = displayRandomQuotes(categoryFiler);
                    /**
                    ...
                    if (shuffled.length > 0) {
                        ...
                        quoteDisplay.innerHTML = "<em>There are no more quotes to display.</em>>";
                        quoteAuthor.innerHTML = "";
                        quoteCategory.innerHTML = "";
                        currentQuote = null;
            ...
            editBtn.addEventListener("click", () => {
                ...
                filterQuotes(newCategoryUpdate, currentQuote.category);
    ...
    function filterQuotes(selectElement, selectedCategory) {
    ...
    updateQuoteBtn.addEventListener("click", async () => {
        ...
        if (quoteValue && categoryValue) {
            try {
                ...
                showRandomQuote();
                quoteUpdateForm.style.dislay = "none";
